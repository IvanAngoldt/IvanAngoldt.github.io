...
function totalSum(v) {
    ...
    let checkBx = document.getElementById("rtx3090");
    ...
    if (select.value === "3") {
        let checkbox = document.getElementsByName("rtx3090");
...
window.addEventListener("DOMContentLoaded", function (event) {
    ...
    let checkbox = document.getElementById("rtx3090");
    ...
    let checkboxBtn = document.getElementsByName("rtx3090");
